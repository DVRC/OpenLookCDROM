...
/*
 * @(#)c_varieties.h 1.3 91/02/21 Copyright 1988-91 Sun Microsystems
 *
...
/*
 *	This is a direct copy of the c_varieties.h provided with the
 *	C++ and XView distributions (the xview version is in
 *	$OPENWINHOME/include/xview/xv_c_types.h).  They should
 *	differ only in the details of the comments
 */

#if ! (defined(C_VARIETIES_H) || defined(XV_C_TYPES_H))
...
#endif /* ! (defined(C_VARIETIES_H) || defined(XV_C_TYPES_H)) */
